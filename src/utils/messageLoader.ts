...
export async function loadMessages(filePath: string = 'pesan.txt'): Promise<boolean> {
  try {
...
export function getRandomMessage(): WelcomeMessage | null {
...
export function setupHotReload(filePath: string = 'pesan.txt'): void {
